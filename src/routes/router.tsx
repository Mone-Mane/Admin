...
const ResetPassword = lazy(
  async () => import("pages/authentication/ResetPassword")
);
const ForgotPassword = lazy(
  async () => import("pages/authentication/ForgotPassword")
);
const Message = lazy(async () => import("pages/home/Message"));
...
const router = createBrowserRouter(routes, { basename: "/sync" });
